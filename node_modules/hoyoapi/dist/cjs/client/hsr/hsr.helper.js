...
var hsr_helper_exports = {};
__export(hsr_helper_exports, {
  getHsrRegion: () => getHsrRegion
});
module.exports = __toCommonJS(hsr_helper_exports);
var import_error = require("../../error");
var import_hsr = require("./hsr.interface");
function getHsrRegion(uid) {
  ...
  return import_hsr.HsrRegion[key];
}
